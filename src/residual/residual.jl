#Make separate functions for different dimensions

function create_residual_function_2D(N, equationsExpr, harmonics)
...
function create_residual_function_1D(N, equationsExpr, harmonics)
    equationsExprMapped::Vector{Expr} = []
    ...
    function_code = quote
        function residual!(F, U, p)
            dx, = p  # What about this line? Is this ever used?
            grid_size = $N
            harmonicsNum = $harmonics
